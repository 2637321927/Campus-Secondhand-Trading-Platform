...
.home-section[aria-labelledby='category-title'] + .home-section { margin-top: 32px; }
...
.product-grid { display: grid; align-items: stretch; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 20px; }
