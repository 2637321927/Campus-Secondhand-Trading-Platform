...
public class ConversationController : ControllerBase
{
    ...
    [HttpPost("{conversationId:int}/attachments")] public async Task<ActionResult<MessageDto>> Attach(int conversationId, [FromForm] IFormFile file, [FromForm] string? content = null) => await Send(conversationId, new SendMessageDto { Content=content }, file);
